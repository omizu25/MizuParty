...
#define STICK_HEIGHT		(90.0f)			// スティックの高さ
...
static LPDIRECT3DTEXTURE9			s_pTextureSkip = NULL;			// スキップのテクスチャへのポインタ
static LPDIRECT3DVERTEXBUFFER9		s_pVtxBuffSkip = NULL;			// スキップの頂点バッファのポインタ
