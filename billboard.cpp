...
#define PLAYER_HEIGHT		(2000.0f)		// 高さ
#define TITLE_WIDTH			(150.0f)		// 幅
#define TITLE_HEIGHT		(100.0f)		// 高さ
#define RULE_WIDTH			(300.0f)		// 幅
#define RULE_HEIGHT			(100.0f)		// 高さ
#define MOVE_WIDTH			(200.0f)		// 幅
#define MOVE_HEIGHT			(100.0f)		// 高さ
